...
var articulate_ui = SAGE2_App.extend( {
	init: function(data) {
		...
		this.specificationObjects = [
			{"horizontalAxis":"NON_UNIT","horizontalGroupAxis":"location","verticalAxis":"TOTAL_CRIME","plotType":"BAR","dataQuery":"SELECT count(*) as TOTAL_CRIME,`location` FROM chicagocrime WHERE (`neighborhood`='loop') AND (`crimetype`='theft') GROUP BY location","dataQueryResult":["(total_crime,35);(location,)","(total_crime,2);(location,abandoned-building)","(total_crime,31);(location,alley)","(total_crime,78);(location,apartment)","(total_crime,4);(location,appliance-store)","(total_crime,255);(location,athletic-club)","(total_crime,10);(location,atm-(automatic-teller-machine))","(total_crime,69);(location,bank)","(total_crime,160);(location,bar-or-tavern)","(total_crime,9);(location,barbershop)","(total_crime,7);(location,boat/watercraft)","(total_crime,1);(location,bowling-alley)","(total_crime,3);(location,bridge)","(total_crime,6);(location,church/synagogue/place-of-worship)","(total_crime,169);(location,college/university-grounds)","(total_crime,38);(location,college/university-residence-hall)","(total_crime,409);(location,commercial-/-business-office)","(total_crime,49);(location,construction-site)","(total_crime,109);(location,convenience-store)","(total_crime,1);(location,credit-union)","(total_crime,131);(location,cta-bus)","(total_crime,15);(location,cta-bus-stop)","(total_crime,66);(location,cta-garage-/-other-property)","(total_crime,525);(location,cta-platform)","(total_crime,22);(location,cta-station)","(total_crime,788);(location,cta-train)","(total_crime,4);(location,currency-exchange)","(total_crime,2);(location,day-care-center)","(total_crime,9);(location,delivery-truck)","(total_crime,3367);(location,department-store)","(total_crime,1);(location,driveway---residential)","(total_crime,206);(location,drug-store)","(total_crime,2);(location,factory/manufacturing-building)","(total_crime,4);(location,federal-building)","(total_crime,2);(location,fire-station)","(total_crime,11);(location,gas-station)","(total_crime,60);(location,government-building/property)","(total_crime,105);(location,grocery-food-store)","(total_crime,5);(location,hospital-building/grounds)","(total_crime,474);(location,hotel/motel)","(total_crime,5);(location,lakefront/waterfront/riverbank)","(total_crime,161);(location,library)","(total_crime,19);(location,medical/dental-office)","(total_crime,43);(location,movie-house/theater)","(total_crime,2);(location,newsstand)","(total_crime,2);(location,nursing-home/retirement-home)","(total_crime,920);(location,other)","(total_crime,6);(location,other-commercial-transportation)","(total_crime,18);(location,other-railroad-prop-/-train-depot)","(total_crime,227);(location,park-property)","(total_crime,571);(location,parking-lot/garage(non.resid.))","(total_crime,2);(location,pawn-shop)","(total_crime,3);(location,police-facility/veh-parking-lot)","(total_crime,133);(location,residence)","(total_crime,51);(location,residence-garage)","(total_crime,15);(location,residence-porch/hallway)","(total_crime,12);(location,residential-yard-(front/back))","(total_crime,2526);(location,restaurant)","(total_crime,249);(location,school)","(total_crime,832);(location,sidewalk)","(total_crime,1059);(location,small-retail-store)","(total_crime,4);(location,sports-arena/stadium)","(total_crime,901);(location,street)","(total_crime,24);(location,tavern/liquor-store)","(total_crime,18);(location,taxicab)","(total_crime,2);(location,vacant-lot/land)","(total_crime,6);(location,vehicle-commercial)","(total_crime,34);(location,vehicle-non-commercial)","(total_crime,2);(location,warehouse)"]}
		];
	...
	event: function(eventType, position, user_id, data, date) {
		if (eventType === "pointerPress" && (data.button === "left")) {
			if( isMaster ){
				...
				this.contactArticulateHub("show me theft in loop by location type");
			}
