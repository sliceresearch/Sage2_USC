...
var Camera = function (element) {
    ...
    this.recomputeViewMatrix = function (el, az) {
        ...
        makeXRotationMatrix(xRotationMatrix, el);
        makeYRotationMatrix(yRotationMatrix, az);
    ...
    this.recomputeViewMatrix(elevation, azimuth);
};

var Flow = function (canvas, ww, hh) {
    var options = {
