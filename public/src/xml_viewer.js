 ...
 * @class xml_viewer
 */
var xml_viewer = SAGE2_App.extend({
		/**
...
init: function(data) {
	...
	gstxb = this;
	console.log(">>>>>URL: " + this.state.doc_url);

	var rawFile = new XMLHttpRequest();
	//rawFile.open("GET", "https://168.105.17.212:9090/uploads/xmls/default777.tkt", false);
	var filePath = this.state.doc_url;
	filePath = filePath.substring(filePath.indexOf("uploads"));
	console.log(">>>>>filePath: " + filePath);
	//rawFile.open("GET", "uploads/xmls/default777.tkt", false);
	//rawFile.open("GET", this.status.file, false);
