...
var DataSharing = function(data) {
	...
	sharingArea.style.webkitTransform = "translate(" + data.left + "px," +
			(data.top + ui.titleBarHeight) + "px) scale(" + this.scaleX + "," + this.scaleY + ")";
	sharingArea.style.mozTransform    = "translate(" + data.left + "px," +
			(data.top + ui.titleBarHeight) + "px) scale(" + this.scaleX + "," + this.scaleY + ")";
	sharingArea.style.transform       = "translate(" + data.left + "px," +
			(data.top + ui.titleBarHeight) + "px) scale(" + this.scaleX + "," + this.scaleY + ")";
	...
	var borderColor = "rgba(" + parseInt(0.6 * borderRGB[0], 10) + ", " + parseInt(0.6 * borderRGB[1], 10) +
			", " + parseInt(0.6 * borderRGB[2], 10) + ", 1.0)";
...
DataSharing.prototype.setPosition = function(left, top) {
	...
	sharingArea.style.webkitTransform = "translate(" + left + "px," +
			(top + ui.titleBarHeight) + "px) scale(" + this.scaleX + "," + this.scaleY + ")";
	sharingArea.style.mozTransform    = "translate(" + left + "px," +
			(top + ui.titleBarHeight) + "px) scale(" + this.scaleX + "," + this.scaleY + ")";
	sharingArea.style.transform       = "translate(" + left + "px," +
			(top + ui.titleBarHeight) + "px) scale(" + this.scaleX + "," + this.scaleY + ")";
