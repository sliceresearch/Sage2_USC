	...
	*/
	this.background = function() {
		...
		if (this.clientID === -1) {
			...
			this.bg.style.width  = this.json_cfg.resolution.width * this.json_cfg.displays[this.clientID].width + "px";
			this.bg.style.height = this.json_cfg.resolution.height * this.json_cfg.displays[this.clientID].height + "px";

			this.main.style.width  = this.json_cfg.resolution.width * this.json_cfg.displays[this.clientID].width + "px";
			this.main.style.height = this.json_cfg.resolution.height * this.json_cfg.displays[this.clientID].height + "px";
