...
appLoader.prototype.loadImageFromURL = function(url, name, callback) {
...
appLoader.prototype.loadPdfFromURL = function(url, name, callback) {
...
appLoader.prototype.loadFileFromWebURL = function(file, callback) {
	...
	if(app === "image_viewer"){
		this.loadImageFromURL(file.url, filename, function(appInstance) {
			callback(appInstance);
		});
	}
		...
		this.loadPdfFromURL(file.url, filename, function(appInstance) {
			callback(appInstance);
		});
	}
};
