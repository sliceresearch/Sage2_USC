...
function omicronManager( sysConfig )
{
	...
	{
		console.log("Omicron: Touch Display Resolution: " + sysConfig.resolution);
		totalWidth = sysConfig.resolution.width;
		totalHeight = sysConfig.resolution.height;
	}
