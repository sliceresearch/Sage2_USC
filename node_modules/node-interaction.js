...
interaction.prototype.keyboardLockedToControl = function(){
	return this.lockedControl;
}

interaction.prototype.lockKeyboardToControl = function(ctrlId){
	return this.lockedControl = ctrlId;
}

interaction.prototype.releaseKeyboard = function(){
	this.lockedControl = null;
}
