...
liveVideoDecoder.prototype.initializeLiveDecoder = function(url) {
	...
	exec(cmd + " -of json -show_streams -show_format " + fURL, function (error, stdout, stderr) {
		...
		if(_this.onmetadata instanceof Function) _this.onmetadata(error, {width: _this.width, height: _this.height, numframes: _this.numframes, framerate: _this.framerate});
	});
};
